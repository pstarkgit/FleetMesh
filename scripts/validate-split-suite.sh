...
run_group 'DoctorPlannerTests|DriftEngineTests|MenuBarSummaryTests|BootstrapPlannerTests|FleetMeshIdentityTests|HeadlessFleetReportTests|FleetEnrollmentInvitationTests|FleetMeshUpdatesTests|FleetInstallerTests|ApplicationDiscoveryTests|ProductVersionTargetResolverTests'
