...
run_group 'DoctorPlannerTests|DriftEngineTests|MenuBarSummaryTests|BootstrapPlannerTests|FleetMeshIdentityTests|HeadlessFleetReportTests|FleetEnrollmentInvitationTests|FleetMeshUpdatesTests|ApplicationDiscoveryTests|ProductVersionTargetResolverTests'
